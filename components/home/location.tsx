            ...
            <div className='w-full'>
                <div className='flex flex-col items-center'>
                    <div className='grid gap-2 flex flex-col items-center gap-[7px] max-w-[777.78px]'>
                        <div className='relative w-fit mx-auto'>
                            <Image width={128.63} height={96.83} alt='logo' src={'/image/logoWithFace.png'} className='object-bottom object-contain  -rotate-[11.13deg] absolute right-full -bottom-4  scale-x-[-1]' />
                            <h2 className='font-gotham font-bold text-[40px] leading-[40px] text-center uppercase'>FIND A zopgolf <span className='bg-[linear-gradient(90deg,#000000_-19.52%,#5EF700_100%)] bg-clip-text text-transparent'>LOCATION</span> </h2>
                        </div>
                ...
                <div className='w-full grid grid-cols-12 lg:aspect-[1440/634.84] mt-[60px]'>
                    <div className='xl:col-span-9 lg:col-span-8 col-span-12 max-lg:aspect-[1/0.5] max-lg:order-2'>
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d56281548.804525375!2d-119.8093025!3d44.24236485!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54eab584e432360b%3A0x1c3bb99243deb742!2sUnited%20States!5e1!3m2!1sen!2s!4v1776888803561!5m2!1sen!2s"
                            width="600"
                            height="450"
                            style={{ border: 0 }}
                            allowFullScreen
                    ...
                    <div className='xl:col-span-3 lg:col-span-4 col-span-12 xl:pt-6 pt-3 max-lg:pb-3 xl:pl-10 pl-5 pr-5 bg-[#E5FFD5]  overflow-auto h-full scrollbarHide max-lg:order-1'>
                        <div className='w-full' >
                            <h4 className='font-gotham font-bold text-[30px] leading-[50px] uppercase mb-[21px]'>ALL LOCATION</h4>
                            <div className='w-full max-lg:flex max-lg:gap-3 max-lg:overflow-auto'>
                            {new Array(6).fill("").map((_, i) => (
                                <div className='lg:w-full max-lg:w-[40%] max-lg:min-w-[40%] max-sm:w-[80%] max-sm:min-w-[80%]' key={i}>
