                    ...
                    <div className='xl:col-span-4 lg:col-span-6 col-span-12 pt-[100px] pb-[17px]'>
                        <div className='flex flex-col items-start gap-3'>
                            <div className='flex items-end relative w-fit'>
                                ...
                                <Image width={178} height={134} alt='logo' src={'/image/logoWithFace.png'} className='object-bottom object-contain -ml-[15px] rotate-[11.13deg] absolute left-full -bottom-4' />
                            </div>
                    ...
                    <div className='xl:col-span-8 lg:col-span-6 col-span-12 max-lg:h-[500px] max-sm:h-[800px]'>
                        <div className='w-full h-full grid sm:grid-cols-2 gap-[14.31px]'>
                            <div className='w-full h-full flex flex-col gap-[14.31px]'>
                                <div className='w-full h-[52%] relative rounded-[15px] overflow-hidden shadow-[4px_4px_50px_50px_#00000014]'>
                                    <Image fill className='object-cover object-center' alt='familyplaying.png' src={'/image/familyplaying.png'}/>
                                </div>
                                <div className='w-full h-[48%] relative rounded-[15px] overflow-hidden '>
                                    <Image fill className='object-cover object-center' alt='familyDinner.png' src={'/image/familyDinner.jpg'}/>
                                </div>
                            </div>
                            <div className='w-full h-full flex flex-col gap-[14.31px]'>
                                <div className='w-full h-[48%] relative rounded-[15px] overflow-hidden '>
                                    <Image fill className='object-cover object-center' alt='familyplayingCelebrate.png' src={'/image/familyplayingCelebrate.png'}/>
                                </div>
                                <div className='w-full h-[52%] relative rounded-[15px] overflow-hidden '>
                                    <Image fill className='object-cover object-center' alt='familyplaying2.png' src={'/image/familyplaying2.png'}/>
                                </div>
                            </div>
                        </div>
                    </div>
