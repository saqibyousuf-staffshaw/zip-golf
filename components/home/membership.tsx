            ...
            <Container>
                <div className='flex flex-col items-center'>
                    <div className='grid gap-2 flex flex-col items-center gap-[7px] max-w-[777.78px]'>
                        <h2 className='font-gotham font-bold text-[40px] leading-[40px] text-center uppercase' data-aos="fade-in" >Join the zipgolf <span className='bg-[linear-gradient(90deg,#000000_-19.52%,#5EF700_100%)] bg-clip-text text-transparent'>membership</span> </h2>
                    ...
                    <div className='w-full'>
                        <div className='w-full flex lg:justify-between justify-center items-center max-lg:flex-wrap xl:gap-7 lg:gap-0 gap-x-3'>
                            <div className='xl:max-w-[259px] lg:max-w-[200px]  lg:w-full w-[40%] bg-[#5EF70033] xl:py-[37px] py-6 xl:px-2 p-1 flex flex-col items-center gap-3 rounded-[20px] max-lg:order-2' data-aos="fade-in" data-aos-delay="300">
                            ...
                            <div className='relative max-lg:order-1 max-lg:w-full'>
                                <Image width={714} height={452} src={'/image/zipcard-new.png'} alt='point.svg' data-aos="fade-in"/>
                                <div className='absolute -bottom-4 left-0 max-lg:hidden'>
                                    <Image width={75} height={75} alt='arrow' src={"/image/arrow.svg"} className='' data-aos="fade-in" data-aos-delay="300"/>
                                </div>
                                <div className='absolute -bottom-4 right-0 scale-x-[-1] max-lg:hidden'>
                                    <Image width={75} height={75} alt='arrow' src={"/image/arrow.svg"} className='' data-aos="fade-in" data-aos-delay="300"/>
                                </div>
                            </div>
                            <div className='xl:max-w-[259px] lg:max-w-[200px]  lg:w-full w-[40%] bg-[#5EF70033] xl:py-[37px] py-6 xl:px-2 p-1 flex flex-col items-center gap-3 rounded-[20px] relative max-lg:order-3' data-aos="fade-in" data-aos-delay="300">
                        ...
                        <div className='flex justify-center items-center max-sm:flex-col gap-[17px] max-lg:mt-10' data-aos="fade-in">
                            <Link href={'#'}>
